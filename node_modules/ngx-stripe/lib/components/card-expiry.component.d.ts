...
export declare class StripeCardExpiryComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StripeCardExpiryComponent, "ngx-stripe-card-expiry", never, { "containerClass": "containerClass"; "options": "options"; }, { "load": "load"; "blur": "blur"; "change": "change"; "focus": "focus"; "ready": "ready"; "escape": "escape"; }, ["loadingTemplate"], never>;
}
